...
- **Дополнительные модели** — [Nagatoro Sprite](https://github.com/nukkerman2000/nagatoru-live2d) (спрайтовая модель в отдельном репозитории)
...
└── assets/live2d/         # Live2D и спрайтовые модели (Hiyori, Nagatoro_sprite)
```
