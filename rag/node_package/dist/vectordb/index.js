...
import { DatabaseError, FTS_CLEANUP_THRESHOLD_MS, FTS_INDEX_NAME, HYBRID_SEARCH_CANDIDATE_MULTIPLIER, toChunkRow, toSearchResult, } from './types.js';
// ============================================
// VectorStore Class
// ============================================
/**
...
export class VectorStore {
    ...
    async ensureSchemaVersion() {
        ...
        const hasFileTitle = schema.fields.some((f) => f.name === 'fileTitle');
        if (!hasFileTitle) {
