...
export function createQualityCaptioner(resolvedDevice) {
    ...
    async function ensureLoaded() {
        ...
        try {
            ...
            const dtypeOpt = { dtype: DTYPE };
            const modelOpt = { dtype: DTYPE, device: resolvedDevice };
            ...
            const wrapped = new Error(`Captioner load failed (modelName=${MODEL_NAME}, device=${resolvedDevice}): ${original.message}`, { cause: original });
