 ...
 */
export function validatePath(value, flagName) {
 ...
 * Returns an error message if invalid, or undefined if valid.
 */
export function validateChunkMinLength(value) {
 ...
 */
export function consumeBaseDirArg(argv, flagIndex, collected) {
 ...
 */
export function resolveGlobalConfig(options) {
 ...
 */
export function resolveDevice(value) {
    if (!value || value.trim() === '')
        return 'cpu';
    return value.trim();
}
